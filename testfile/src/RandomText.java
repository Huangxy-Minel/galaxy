// Function: Generate random bits text files
// Author: MinelHuang
// Date: 2021/04/27
// UESTC & HKUST
...
public class RandomText{
    /**
    * Input: args[0]: bits; args[1]: Output path
    * example: RandomText 1073741824 /user/galaxy/mrinput
     */
    public static void main(String[] args){
        ...
        // Path outputPath = new Path(fs.getHomeDirectory(), args[1]);
        ...
        String localPath = "/home/galaxy/galaxy/testfile/random_text";
        while (currentBytes < totalBytes) {
            // write words to outputfile
            try{
                FileWriter writer = new FileWriter(localPath + String.valueOf(fileIndx),true);
                System.out.println("Writing file: random_text" + String.valueOf(fileIndx));
                while(currentBytes < 104857600){     // 100MB
                    int r = random.nextInt(max)%(max-min+1) + min;
                    writer.write(words[r] + " ");

                    currentBytes += words[r].length() + 1;
                    wordsNum++;
                    if (wordsNum >= 10) {
                        writer.write("\n");
                        wordsNum = 0;
